...
from src.utils import check_query_status, export_geneexpression_to_csv, fetch_animals_pets_to_dataframe, fetch_animals_prod_to_dataframe, fetch_kits_prod_to_dataframe, fetch_microbiome_to_dataframe, export_histopathology_to_dataframe, fetch_otu_counts_to_dataframe, fetch_taxonomy_to_dataframe, get_pycon
...
def load_prod_otucount_table_athena(project_ids):
    ...
    filtered_df['Adjusted Sample ID'] = filtered_df['sampleid'].str.slice(0, -3)
